...
@section('conteudo')
    <div class="col-sm-12">
        <div class="card">
            ...
            <form class="form-material" id="permissoesForm" action="{{ route('administracao.sistema.permissoes.store') }}"
                method="POST" role="form">
                @csrf
                <div class="card-block">
                    <div class="form-row justify-content-center align-center">
                        <input id="id" name="id" type="hidden" value="{{ $permissoes->id }}">

                        <div class="form-group form-default form-static-label col-md-4">
                            <input type="text" id="nome" name="nome" class="form-control"
                                value="{{ old('nome', $permissoes->nome) }}">
                        ...
                        <div class="form-group form-default form-static-label col-md-4">
                            <input type="text" id="descricao" name="descricao" class="form-control"
                                value="{{ old('descricao', $permissoes->descricao) }}">
                            <span class="form-bar"></span>
                        ...
                        <div class="form-group form-default form-static-label col-md-4">
                            <select name="ativo" id="ativo" class="form-control">
                                ...
                                <option value="1" @selected(old('ativo', $permissoes->ativo) == '1')>SIM</option>
                                <option value="0" @selected(old('ativo', $permissoes->ativo) == '0')>NÃO</option>
                            </select>
                            <span class="form-bar"></span>
                                ...
                                @foreach ($funcoes as $f)
                                    <div class="form-check form-check-inline mr-3 mb-2" style="margin:0">
                                        <input type="checkbox" class="form-check-input funcao-item"
                                            ...
                                            @checked(in_array($f->id, $selecionadas, true))>
    ...
    <script>
        $(function() {
            ...
            const messages = {
                ...
                ativo: {
                    required: "Informe o status (Ativo)."
                }
            };

            const form = $("#permissoesForm");
