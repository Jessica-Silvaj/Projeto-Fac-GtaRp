...
$(document).ready(function () {
    $("#pcoded").pcodedmenu({
        ...
        ThemeBackgroundPattern: 'theme5',  // pattern1, pattern2, pattern3, pattern4, pattern5, pattern6
        HeaderBackground: 'theme5',  // theme5, theme2, theme3, theme4, theme5  header color
        LHeaderBackground: 'theme5', // theme5, theme2, theme3, theme4, theme5, theme6   brand color
        NavbarBackground: 'themelight1', // themelight1, theme5  // light  and dark sidebar
        ActiveItemBackground: 'theme5', // theme5, theme2, theme3, theme4, theme5, theme6, theme7, theme8, theme9, theme50, theme51, theme52  mennu active item color
    ...
    function handlelayouttheme() {
        $('.theme-color > a.Layout-type').on("click", function () {
            ...
            if(layout=='dark'){
                ...
                $('.pcoded-navbar').attr("navbar-theme", "theme5");
            ...
            if(layout=='light'){
                ...
                $('.pcoded').attr("sidebar-img", "false");
                $('.pcoded-navigation-label').attr("menu-title-theme", "theme5");
                $('body').removeClass('dark');
				$('body').attr("themebg-pattern", "theme5");
            }
            if(layout=='img'){
               $('.pcoded-header').attr("header-theme", "theme5");
               $('.pcoded-navbar').attr("navbar-theme", "themelight1");
               $('.pcoded').attr("sidebar-img", "true");
                $('.pcoded').attr("frame-type", "theme5");
               $('.pcoded-navigation-label').attr("menu-title-theme", "theme5");
           }
        });
    };
