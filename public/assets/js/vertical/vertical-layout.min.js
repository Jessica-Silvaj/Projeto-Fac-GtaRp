...
$(document).ready(function () {
    ...
    function a() {
        $(".theme-color > a.Layout-type").on("click", function () {
            ...
            if (C == "dark") {
                ...
                $("body").addClass("dark"); $("body").attr("themebg-pattern", "theme6");
            ...
            if (C == "light") {
                ...
                $("body").removeClass("dark"); $("body").attr("themebg-pattern", "theme6")
            }
            if (C == "img") {
                $(".pcoded-header").attr("header-theme", "theme6");
                $(".pcoded-navbar").attr("navbar-theme", "themelight1");
    ...
    function s() {
        $("#vertical-border-style").val("solid").on("change", function (C) {
            C = $(this).val(); $(".pcoded-navbar .pcoded-item").attr("item-border-style", C)
        })
    }
    s();
    function v() {
        $("#vertical-dropdown-icon").val("style1").on("change", function (C) {
            C = $(this).val(); $(".pcoded-navbar .pcoded-hasmenu").attr("dropdown-icon", C)
        })
    }
    v();
    function z() {
